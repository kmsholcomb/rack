...
2. Make the binary executable. If you are unfamiliar with this process or you are running Windows, go to :ref:`installation_and_configuration` for instructions.
